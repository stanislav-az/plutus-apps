...
Full examples of Plutus Applications can be found in the ``plutus-apps`` `repository <https://github.com/stanislav-az/plutus-apps/tree/main/plutus-use-cases>`_.
