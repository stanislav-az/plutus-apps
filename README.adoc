= https://github.com/stanislav-az/plutus-apps[The Plutus Application Framework]
...
Issues can be filed in the https://github.com/stanislav-az/plutus-apps/issues[GitHub Issue tracker].
...
The https://github.com/stanislav-az/plutus-starter[plutus-starter] project provides an example.
...
For more details, including instructions for setting up ad hoc testing deployments, see https://github.com/stanislav-az/plutus-ops[the plutus-ops repo].
